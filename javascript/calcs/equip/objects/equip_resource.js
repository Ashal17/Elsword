...
accs_guild_passive = {
    ...
    "hunters_instinct": { "id": 13, "required": 15, "name": "Hunter's Instinct", "desc": "Increase damage against boss monsters while decrease damage from boss monsters", "shown_stat": [{ "left": ["Damage to Boss Monsters"], "right": ["+", 0.5, "%"] }, { "left": ["Damage from Boss Monsters Decrease"], "right": ["+", 0.5, "%"] }], "actual_stat": [["bossdmg_mod", 0.5]] },
